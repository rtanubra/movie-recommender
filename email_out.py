...
class EmailContact:
    ...
    def send_email(self,email_adress,top_three,movie_reviews):
        ...
        This weekend (pulled on {date.today()}) here are my three reccomendations:


            1. RT blended score of {movie_reviews[top_three[0]][0]} :  {top_three[0].replace("_"," ")} 

            2. RT blended score of {movie_reviews[top_three[1]][0]} :  {top_three[1].replace("_"," ")} 

            3. RT blended score of {movie_reviews[top_three[2]][0]} :  {top_three[2].replace("_"," ")} 
